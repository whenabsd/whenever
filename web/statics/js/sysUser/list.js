...
function deleteUser(obj){
	$.ajax({
		type:"POST",
		url:path+"/sys/user?method=delUser&userid="+obj.attr("userid"),
...
$(function(){
    ...
    $(".viewUser").on("click",function(){
        ...
        var obj = $(this);
        window.location.href=path+"/sys/user?method=viewUser&userid=" + obj.attr("userid");
    });
    /*$(".viewUser").on("click",function(){
        //将被绑定的元素（a）转换成jquery对象，可以使用jquery方法
        var obj = $(this);
	...
	$(".modifyUser").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/sys/user?method=toUpdate&userid="+ obj.attr("userid");
	});
